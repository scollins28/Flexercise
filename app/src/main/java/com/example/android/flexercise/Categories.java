...
public class Categories extends Fragment {
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (v == backButton) {
                    ...
                    HomeScreen.exerciseCategory = 1;
                    position = 1;
                } else if (v == backCategoryButton) {
                    HomeScreen.exerciseCategory = 5;
                    position = 1;
                } else if (v == armsCategoryButton) {
                    HomeScreen.exerciseCategory = 3;
                    position = 1;
                } else if (v == absCategoryButton) {
                    HomeScreen.exerciseCategory = 4;
                    position = 1;
                } else if (v == legsCategoryButton) {
                    HomeScreen.exerciseCategory = 2;
                    position = 1;
                } else if (v == cardioCategoryButton) {
                    HomeScreen.exerciseCategory = 6;
                    position = 1;
                }
    ...
    public void onAttach(Context context) {
        ...
        try {
            mCallback = (Categories.OnCategorySelected) context;
