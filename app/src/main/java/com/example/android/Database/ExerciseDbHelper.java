...
import com.example.android.Database.ExerciseContract.ExerciseTable;


public class ExerciseDbHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "exerciseDatabase.db";
    public static final int VERSION_NUMBER = 11;

    public ExerciseDbHelper (Context context){
        super (context, DATABASE_NAME, null, VERSION_NUMBER);
        Log.e("New Table", String.valueOf( VERSION_NUMBER ));
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_EXERCISE_TABLE = "CREATE TABLE " +
                ...
                ExerciseTable.EXERCISE_TYPE + " INTEGER DEFAULT 0," +
                ...
                ExerciseTable.DISTANCE + " INTEGER DEFAULT 0," +
                ExerciseTable.MINUTES + " INTEGER DEFAULT 0," +
